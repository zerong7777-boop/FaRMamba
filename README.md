...
Official PyTorch implementation of **FaRMamba**: *Frequency-based Learning and Reconstruction Aided Mamba for Medical Image Segmentation* (accepted at **ICONIP 2025**).
